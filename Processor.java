...
public class Processor {
    ...
    public void processSettings() {
        for (String[] value : this.settings) {
            ...
            if ("doctype".equals(value[0])) {
                ...
                this.output.add(Parser.parse("favicon", Parser.getRelativePath() + value[1], Settings.FORMAT_FAVICON));
            }
        }
    }
    ...
    public void processStyles() {
        for (String[] value : this.styles) {
            // znacka
            this.output.add(Parser.parse(Parser.getRelativePath() + value[0], value[1], Settings.FORMAT_STYLES));
        }
    }
    ...
    public void processScripts() {
        for (String[] value : this.scripts) {
            // znacka
            this.output.add(Parser.parse("script", Parser.getRelativePath() + value[1], Settings.FORMAT_SCRIPTS));
        }
    }
}
